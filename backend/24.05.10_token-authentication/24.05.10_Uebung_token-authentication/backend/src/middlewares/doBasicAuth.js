...
//# error messages wieder rauslöschen!
...
export async function doBasicAuth(req, res, next) {
  ...
  // userId aus req.params mit req.headers abgleichen, damit jeder User wirklich nur auf seine Inhalte zugreifen kann
  // falls man Profilansichten hat, funktioniert das nicht - dann müsste die Authentifizierung ausschließlich über req.headers stattfinden und in der URL müsste dann die userId vom gewünschten Profil übergeben werden
