...
const Newslist = () => {
  ...
  return (
    <section>
      ...
      {/* - Hier rendern wir die News mit Komponenten */}
      <h2>Map mit Komponente</h2>
      <div className="grid-news">
        {artikelArray.map((singleItem, index) => (
          <Newsitem datenpaket={singleItem} key={index} />
        ))}
      </div>

      {/* - Hier rendern wir die News Artikel ohne Komponenten: */}
      <h2>Map ohne Komponente</h2>
      <div className="grid-news">
